<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminMails.aspx.cs" Inherits="HospitalManagement.AdminMails" %>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" role="button" data-toggle="dropdown" href="#">
            <i class="glyphicon glyphicon-user"></i> <asp:Label ID="aDmName" runat="server"
...
<div class="container">
  ...
  <div class="row">
	<div class="col-sm-3">
      ...
      <h3 class="text text-center"><i class="glyphicon glyphicon-briefcase"></i> MENU</h3>
      <hr>
    ...
    <div class="col-sm-9">
       ...
       <h3 class="text-center text-uppercase"><i class="glyphicon glyphicon-dashboard"></i> SEND MESSAGE</h3>  
	   ...
	   <div class="row">
         	...
         	<div class="col-md-12">
			  ...
			  <div class="well well-sm alert-warning text-center">Remember to log out before exiting the page <span class="badge pull-right">!</span></div>
