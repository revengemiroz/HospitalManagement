...
<body style=" background-image:url(../Pictures/backgrounad.jpg)" >
<form  runat="server">
    
        <div class="navbar"></div>
        <div class="container">
          <div class="jumbotron">
        <h1 class="text-center text-hide">Welcome to Log in page</h1>
        </div>
  </div>
 ...
 <div class="container">
     <div id="AlertModal" class="modal fade">
                <div class="modal-dialog">
                 <div class="modal-content">
                     <div class="modal-header">
                        <h3 class="text-center text-danger">Log-in failed!</h3>
                 <hr />
                         <div class="modal-body">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                     <p class="text-center  text-info">Incorrect user details!  modal 1 try again..</p>
                    </div>
                     </div>
        ...
        <div id="AlertModal2" class="modal fade">
                <div class="modal-dialog">
                 ...
                 <div class="modal-body">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <p class="text-center text-info"> No such User exist! modal2</p>
                    </div>
                     </div>
     ...
     <div id="AlertModala" class="modal fade">
                <div class="modal-dialog">
                 ...
                 <hr />
                         <div class="modal-body">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                     <p class="text-center text-info"> No admin rights to this user! modal a try again..</p>
                    </div>
                     </div>
        ...
        <div id="AlertModal2a" class="modal fade">
                <div class="modal-dialog">
                 ...
                 <div class="modal-body">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                   <p class="text-center text-info">  No such User exist! modal 2a </p>
                    </div>
                     </div>
     ...
     <div class="modal fade " id="Logmodal" data-backdrop="static">
        ...
        <div class="modal-content">
            ...
            <div class="col-md-5">
            <h3 class="text-muted">For Members log-in</h3> 
    
            <asp:ScriptManager ID="ScriptManager" runat="server"></asp:ScriptManager>

                    <asp:Label ID="Label" runat="server" Text="Username"></asp:Label>
                    &nbsp;&nbsp;
                    <asp:TextBox ID="UsernameID" runat="server" MaxLength="20" CssClass="form-control"></asp:TextBox>
                    &nbsp;
